...
-(void)gradientFrame:(CGRect)frame
          startPoint:(CGPoint)startPoint
            endPoint:(CGPoint)endPoint
              colors:(NSArray <UIColor *>*)colors
           locations:(NSArray *)locations
        atLayerIndex:(NSInteger)atLayerIndex{
    
    CAGradientLayer *gl = [CAGradientLayer layer];
    gl.frame = frame;
    gl.startPoint = startPoint;
    gl.endPoint = endPoint;
    NSMutableArray *colorsTmp = @[].mutableCopy;
    
    for (UIColor *tmp in colors) {
        [colorsTmp addObject:(__bridge id)tmp.CGColor];
    }
    gl.colors = colorsTmp;
...
- (void)drawLineOfDashWithStartPoint:(CGPoint)stratPoint
                            endPoint:(CGPoint)endPoint
                               frame:(CGRect)frame
...
//    if (isHorizonal) {
//
//        [shapeLayer setPosition:stratPoint];
//
//    } else{
//        [shapeLayer setPosition:stratPoint];
//    }
    ...
    CGPathMoveToPoint(path, NULL, stratPoint.x, stratPoint.y);
...
@implementation UIView (resignAllResponder)
