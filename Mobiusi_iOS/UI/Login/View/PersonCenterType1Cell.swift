...
class PersonCenterType1Cell: MOTableViewCell,@preconcurrency PersonCenterTypeCellProviding {
    ...
    public let rightLargeImage:UIImageView = {
        let image:UIImageView = UIImageView()
        
        return image
    }()
    
    class func dequeueReusableCell(tableView:UITableView,identifier:String,title:String,subTitle:String)->PersonCenterType1Cell? {
        let cell =  tableView.dequeueReusableCell(withIdentifier: identifier)
        let cell1 = cell as? PersonCenterType1Cell
        cell1?.leftLabel.text = title
        cell1?.rightLabel.text = subTitle
        return cell1
    }
    ...
    override func addSubViews() {
        ...
        self.contentView.addSubview(rightLargeImage)
        rightLargeImage.snp.makeConstraints { make in
            make.right.equalTo(self.contentView.snp.right).offset(-25)
            make.centerY.equalTo(self.contentView.snp.centerY)
